...
import { CreateStoreRequest, StoreFeature } from '@/types';
...
export default function CreateStorePage() {
  ...
  const handleSubmit = async (values: StoreFormData) => {
    try {
      ...
      const newStore = await createStoreMutation.mutateAsync(storeData);
    ...
    <div className="p-6">
      <Space direction="vertical" size="large" className="w-full">
        ...
        <div>
          ...
          <Title level={2}>新しい店舗を作成</Title>
          <Text type="secondary">
            新しい店舗の基本情報と設定を入力してください
          </Text>
        </div>
